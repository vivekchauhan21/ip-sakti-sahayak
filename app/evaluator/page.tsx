...
import { validateBotanicalInput } from "@/lib/botanicalValidator";
...
export default function Home() {
  ...
  const evaluateLocally = (data: Record<string, any>, jur: "india" | "international") => {
    if (jur === "international") {
      if (data.purified_fraction && data.synergistic_efficacy) {
        return {
          ...
          steps: [
            {
              title: "WIPO PCT International Filing (RO/IN)",
              desc: "File Form PCT/RO/101 designating US, EPO & ASEAN territories",
              status: "MANDATORY",
              color: "rose",
              titleKey: "wipo_pct_filing",
              descKey: "wipo_pct_filing_desc",
              statusKey: "badge_mandatory",
            },
            {
              title: "WIPO GRATK Mandatory Origin Disclosure",
              desc: "Mandatory declaration of Indian genetic resource sourcing",
              status: "STATUTORY",
              color: "rose",
              titleKey: "wipo_gratk_disclosure",
              descKey: "wipo_gratk_disclosure_desc",
              statusKey: "badge_statutory",
            },
            {
              title: "Nagoya Protocol ABS Compliance (CBD)",
              desc: "Obtain Internationally Recognized Certificate of Compliance (IRCC)",
              status: "REQUIRED",
              color: "rose",
              titleKey: "nagoya_abs_compliance",
              descKey: "nagoya_abs_compliance_desc",
              statusKey: "badge_required",
            },
            {
              title: "US FDA IND Botanical Dossier",
              desc: "Chemistry, Manufacturing, and Controls (CMC) batch fingerprinting",
              status: "ADVISED",
              color: "amber",
              titleKey: "us_fda_ind_dossier",
              descKey: "us_fda_ind_dossier_desc",
              statusKey: "badge_advised",
            },
          ],
        };
      }
      ...
      return {
        ...
        steps: [
          {
            title: "EU Simplified Registration Dossier",
            desc: "Demonstrate 30 years medicinal use (including 15 years in EU)",
            status: "MANDATORY",
            color: "rose",
            titleKey: "eu_simplified_reg",
            descKey: "eu_simplified_reg_desc",
            statusKey: "badge_mandatory",
          },
          {
            title: "WIPO Defensive Vault Anchor",
            desc: "Publish cryptographic prior art to prevent foreign corporate piracy",
            status: "URGENT",
            color: "rose",
            titleKey: "wipo_vault_anchor",
            descKey: "wipo_vault_anchor_desc",
            statusKey: "badge_urgent",
          },
          {
            title: "International ABS Benefit Sharing",
            desc: "Clear bilateral access permissions under Nagoya clearing-house",
            status: "REQUIRED",
            color: "amber",
            titleKey: "intl_abs_sharing",
            descKey: "intl_abs_sharing_desc",
            statusKey: "badge_required",
          },
          {
            title: "CITES Flora Export Verification",
            desc: "Obtain clearance if species is listed under CITES Appendix II",
            status: "CHECK",
            color: "blue",
            titleKey: "cites_flora_export",
            descKey: "cites_flora_export_desc",
            statusKey: "badge_check",
          },
        ],
      };
    }
    ...
    if (data.purified_fraction && data.synergistic_efficacy) {
      return {
        ...
        steps: [
          {
            title: "CDSCO Central Licensing (Form 44)",
            desc: "Submit IND package and chemistry manufacturing controls",
            status: "REQUIRED",
            color: "rose",
            titleKey: "cdsco_licensing",
            descKey: "cdsco_licensing_desc",
            statusKey: "badge_required",
          },
          {
            title: "Phase I to IV Clinical Trials",
            desc: "Adhere to New Drugs and Clinical Trials Rules 2019",
            status: "REQUIRED",
            color: "rose",
            titleKey: "clinical_trials",
            descKey: "clinical_trials_desc",
            statusKey: "badge_required",
          },
          {
            title: "Quality Dossier Fingerprinting",
            desc: "Mandatory HPLC/HPTLC/LC-MS batch uniformity evidence",
            status: "REQUIRED",
            color: "rose",
            titleKey: "quality_dossier",
            descKey: "quality_dossier_desc",
            statusKey: "badge_required",
          },
          {
            title: "State Biodiversity Board (SBB) Intimation",
            desc: "File Form I prior intimation under BDA 2024",
            status: "ADVISED",
            color: "amber",
            titleKey: "sbb_intimation",
            descKey: "sbb_intimation_desc",
            statusKey: "badge_advised",
          },
        ],
      };
    ...
    if (data.ayurveda_aahar) {
      return {
        ...
        steps: [
          {
            title: "FSSAI Special AYUSH Licensing",
            desc: "Mandatory Form B registration under Ayurveda Aahar regulations",
            status: "REQUIRED",
            color: "rose",
            titleKey: "fssai_licensing",
            descKey: "fssai_licensing_desc",
            statusKey: "badge_required",
          },
          {
            title: "Heavy Metal & Microbial Testing",
            desc: "Compliant with Food Safety and Standards permissible limits",
            status: "REQUIRED",
            color: "rose",
            titleKey: "heavy_metal_testing",
            descKey: "heavy_metal_testing_desc",
            statusKey: "badge_required",
          },
          {
            title: "Labeling & Non-Medical Claims",
            desc: "Strictly prohibit therapeutic disease claims on packaging",
            status: "REQUIRED",
            color: "rose",
            titleKey: "labeling_claims",
            descKey: "labeling_claims_desc",
            statusKey: "badge_required",
          },
          {
            title: "SBB Domestic Exemption Verification",
            desc: "Exempt from commercial ABS levy for declared dietary food",
            status: "EXEMPT",
            color: "emerald",
            titleKey: "sbb_exemption",
            descKey: "sbb_exemption_desc",
            statusKey: "badge_exempt",
          },
        ],
      };
    }
    ...
    if (data.classical_ref && data.classical_method && !data.purified_fraction) {
      return {
        ...
        steps: [
          {
            title: "State Licensing Authority (SLA) Approval",
            desc: "Apply under Rule 153 for classical Shastriya formulation",
            status: "REQUIRED",
            color: "rose",
            titleKey: "sla_approval",
            descKey: "sla_approval_desc",
            statusKey: "badge_required",
          },
          {
            title: "TKDL Defensive Vault Anchoring",
            desc: "Generate SHA-256 hash to preempt biopiracy by foreign MNCs",
            status: "RECOMMENDED",
            color: "amber",
            titleKey: "tkdl_vault_anchor",
            descKey: "tkdl_vault_anchor_desc",
            statusKey: "badge_recommended",
          },
          {
            title: "Pharmacopoeial Standards Testing",
            desc: "Meet Ayurvedic Pharmacopoeia of India (API) specifications",
            status: "REQUIRED",
            color: "rose",
            titleKey: "pharmacopoeial_testing",
            descKey: "pharmacopoeial_testing_desc",
            statusKey: "badge_required",
          },
          {
            title: "State Biodiversity Board (Form I)",
            desc: "File prior intimation for raw herbal ingredient sourcing",
            status: "MANDATORY",
            color: "rose",
            titleKey: "sbb_form1",
            descKey: "sbb_form1_desc",
            statusKey: "badge_mandatory",
          },
        ],
      };
      ...
      steps: [
        {
          ...
          desc: "Form 25D submission to State Licensing Authority",
          status: "REQUIRED",
          color: "rose",
          titleKey: "ayush_mfg_license",
          descKey: "ayush_mfg_license_desc",
          statusKey: "badge_required",
        },
        {
          title: "Pilot Safety & Efficacy Documentation",
          desc: "Generate published literature evidence or observational clinical data",
          status: "REQUIRED",
          color: "rose",
          titleKey: "pilot_safety_doc",
          descKey: "pilot_safety_doc_desc",
          statusKey: "badge_required",
        },
        {
          title: "Synergy Bioassay Verification",
          desc: "Establish biological synergy to survive patent examiner scrutiny",
          status: "CRITICAL",
          color: "amber",
          titleKey: "synergy_bioassay",
          descKey: "synergy_bioassay_desc",
          statusKey: "badge_critical",
        },
        {
          title: "SBB Access Clearance",
          desc: "Complete Form I filing before commercial marketing",
          status: "REQUIRED",
          color: "rose",
          titleKey: "sbb_access_clearance",
          descKey: "sbb_access_clearance_desc",
          statusKey: "badge_required",
        },
      ],
    };
  ...
  const [assessment, setAssessment] = useState<AssessmentResult | null>(() => {
    const val = validateBotanicalInput(formData.search_query);
    return val.isValid ? evaluateLocally(formData, jurisdiction) : null;
  });
  ...
  useEffect(() => {
    ...
    if (active && active.name) {
      ...
      const val = validateBotanicalInput(active.name);
      if (val.isValid) {
        setAssessment(evaluateLocally(restoredData, active.jurisdiction || "india"));
        setValidationError(null);
      } else {
        setAssessment(null);
        setValidationError(val.errorMessage || "Invalid botanical input. Please specify valid Ayurvedic dravya, extract, or standardized phytochemical fractions (e.g., Ashwagandha, Withaferin-A, Piperine).");
      }
    }
  }, []);
  ...
  const runEvaluation = async (dataToEvaluate = formData, jur = jurisdiction) => {
    // 1. Strict Botanical Relevance & Input Validation
    const validation = validateBotanicalInput(dataToEvaluate.search_query);
    if (!validation.isValid) {
      setValidationError(
        validation.errorMessage ||
          "Invalid botanical input. Please specify valid Ayurvedic dravya, extract, or standardized phytochemical fractions (e.g., Ashwagandha, Withaferin-A, Piperine)."
      );
      setAssessment(null);
      setLoading(false);
      return;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => {
                  setFormData((prev) => ({ ...prev, search_query: e.target.value }));
                  if (validationError) setValidationError(null);
                }}
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    e.preventDefault();
                    runEvaluation(formData, jurisdiction);
                  }
                }}
                placeholder="e.g. Ashwagandha, Brahmi, Shatavari..."
                className={`w-full bg-slate-950/80 border rounded-xl px-3.5 py-2.5 text-xs text-slate-200 focus:outline-none transition ${
                  validationError
                    ? "border-rose-500 focus:border-rose-500 shadow-sm shadow-rose-950/30"
                    : "border-slate-800 focus:border-emerald-500"
                }`}
              />
            </div>
            {validationError && (
              <div className="flex items-start gap-2 p-2.5 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-300 text-xs animate-in fade-in duration-200">
        ...
        <section className="lg:col-span-6 bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 backdrop-blur-sm space-y-6">
          ...
          {!assessment ? (
            <div className="py-14 px-6 text-center space-y-4 rounded-xl border border-dashed border-slate-800 bg-slate-950/40 animate-in fade-in duration-200">
              <div
              ...
              >
                {validationError ? <AlertCircle size={22} /> : <Leaf size={22} />}
              </div>
              <div className="space-y-1.5 max-w-md mx-auto">
                <h3 className="text-sm font-semibold text-slate-200">
                  {validationError ? "Evaluation Blocked: Non-Botanical Input" : "Awaiting Valid Botanical Input"}
                </h3>
                <p className="text-xs text-slate-400 leading-relaxed">
                  {validationError
                    ? "Statutory patentability & AYUSH classification requires authentic botanical dravyas, classical grantha preparations, or verified phytochemical fractions."
                    : "Enter or select a verified Ayurvedic dravya, standardized extract, or classical formulation to generate patentability findings."}
                </p>
              </div>
              <div className="pt-2 flex flex-wrap justify-center gap-2">
                {DEMO_PRESETS.map((preset) => (
                  <button
                    ...
                    className="text-[11px] px-2.5 py-1 rounded-lg bg-slate-900 hover:bg-slate-800 border border-slate-800 text-emerald-400 transition cursor-pointer"
                  >
                    {preset.name}
                  </button>
                ))}
            ...
            <>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-300">
                    {t.statutory_checklist || (jurisdiction === "india" ? "National Statutory Checklist" : "Treaty Compliance Checklist")}
                  </span>
                  <span className="text-slate-500 font-mono text-[11px]">
                    {assessment.steps.length} {t.requirements || "requirements"}
                  </span>
                </div>
                <ul className="space-y-2">
                  {assessment.steps.map((step: AssessmentStep, idx: number) => {
                    ...
                    const localizedDesc =
                      ...
                      t[step.desc] ||
                      step.desc;
                    const badgeKey = step.statusKey || `badge_${step.status.toLowerCase()}`;
                    const localizedBadge =
                      (step.statusKey && t[step.statusKey]) ||
                      t[badgeKey] ||
                      t[step.status.toLowerCase()] ||
                      t[step.status] ||
                      step.status;
                    ...
                    return (
                      <li key={idx} className="flex items-start gap-3 p-2.5 rounded-lg border border-slate-800/80 bg-slate-950/40">
                        ...
                        <div className="flex-1 min-w-0">
                          <strong className="text-xs text-slate-200 block">{localizedTitle}</strong>
                          <span className="text-[11px] text-slate-500 block">{localizedDesc}</span>
                        </div>
                        <span
              ...
              <DossierExportButton
                data={{
                  ...
                  mandatorySteps: assessment.steps.map((s: AssessmentStep) => {
                    const title = (s.titleKey && t[s.titleKey]) || t[s.title] || s.title;
                    const badge = (s.statusKey && t[s.statusKey]) || t[`badge_${s.status.toLowerCase()}`] || t[s.status] || s.status;
                    return `${title} (${badge})`;
                  }),
                }}
              />
